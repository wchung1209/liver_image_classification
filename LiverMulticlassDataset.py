...
class LiverMulticlassDataset(Dataset):
    """
    PyTorch Dataset for multiclass classification of liver ultrasound images.
    ...
    Returns (image_tensor, mask_tensor, label_tensor) per sample:
        ...
        - mask_tensor:  FloatTensor, shape (3, H, W), masks
        - label_tensor: FloatTensor, shape (), {0.,1.,2.}
    """
